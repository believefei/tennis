...
function buildFamilyReceiptSvg() {
  ...
  const billRows = BILL_ITEMS.map(
    (item, i) => `
            <div class="bill-fo-row" style="display:flex;align-items:baseline;margin-bottom:${i === BILL_ITEMS.length - 1 ? 0 : 14}px;">
              <svg width="10" height="10" viewBox="0 0 10 10" style="flex-shrink:0;margin-right:12px;align-self:center;">
                <circle cx="5" cy="5" r="4.5" fill="none" stroke="#1a1a1a" stroke-width="1.8" />
              </svg>
              <span style="flex:1;font-size:23px;color:#1a1a1a;min-width:0;word-break:break-all;">${item.label}</span>
              <span style="flex-shrink:0;font-size:${item.amount.length > 14 ? 16 : 20}px;color:var(--accent);margin-left:8px;text-align:right;word-break:break-all;">${item.amount}</span>
            </div>
          `,
  ).join("");

  const paperPathD =
    "M0,0 L52,0 L71,1 L227,2 L279,6 L285,7 L285,9 L290,9 L299,15 L304,19 L307,20 L313,29 L317,34 L323,45 L327,52 L330,58 L335,66 L343,83 L350,96 L359,109 L359,111 L340,112 L334,113 L296,116 L257,119 L244,120 L242,137 L238,179 L236,268 L234,316 L230,361 L226,395 L221,421 L214,452 L208,473 L203,488 L195,514 L191,527 L179,562 L175,571 L170,582 L165,594 L155,617 L146,636 L133,659 L123,676 L116,688 L111,700 L109,700 L107,706 L95,728 L89,740 L86,742 L88,737 L96,721 L99,715 L103,708 L108,698 L116,683 L122,672 L131,657 L138,646 L149,623 L156,608 L161,595 L166,584 L175,565 L181,548 L186,534 L190,521 L193,511 L197,498 L205,472 L209,459 L214,440 L217,426 L220,413 L226,371 L228,346 L230,329 L232,297 L235,196 L237,159 L239,134 L243,113 L246,101 L247,101 L247,110 L245,118 L250,117 L265,116 L268,115 L324,111 L340,109 L355,108 L346,94 L337,77 L329,60 L326,55 L320,45 L314,35 L305,23 L293,14 L289,12 L283,12 L278,16 L270,29 L267,35 L265,41 L261,51 L255,72 L249,97 L247,100 L247,93 L254,64 L262,40 L266,31 L270,23 L273,20 L276,15 L281,10 L258,8 L251,6 L184,5 L141,5 L65,4 L52,3 L1,3 L-9,6 L-18,15 L-27,28 L-34,48 L-40,73 L-41,74 L-44,96 L-45,107 L-45,157 L-44,195 L-42,237 L-42,286 L-45,320 L-52,342 L-48,362 L-56,382 L-50,402 L-58,422 L-53,442 L-60,460 L-55,478 L-62,495 L-56,513 L-63,520 L-57,508 L-50,488 L-47,470 L-52,450 L-46,430 L-51,410 L-45,390 L-49,370 L-43,350 L-50,330 L-44,310 L-49,290 L-43,270 L-48,250 L-42,230 L-47,210 L-41,190 L-46,170 L-40,150 L-45,130 L-39,110 L-44,90 L-38,70 L-43,50 L-37,35 L-33,25 L-26,16 L-19,9 L-12,5 L-7,2 Z";

  return `
    <svg class="training-bill-svg training-bill-svg--family" viewBox="0 0 1078 927" aria-label="Family investment bill" role="img">
      <defs>
        <radialGradient id="familyPaperGlow" cx="50%" cy="50%" r="70%">
          <stop offset="0%" stop-color="#fffdf8" />
          <stop offset="100%" stop-color="#f8f2e8" />
        </radialGradient>
        <clipPath id="familyContentClip">
          <path d="M348 144 C343 214 344 330 336 470 C329 590 286 704 206 818 L596 818 C665 684 706 569 715 430 C723 312 723 218 717 148 C712 127 698 116 672 114 L394 114 C368 116 354 126 348 144 Z" />
        </clipPath>
      </defs>

      <path class="bill-paper" d="${paperPathD}" transform="translate(471,31)" fill="url(#familyPaperGlow)" />
      <path class="bill-line" d="${paperPathD}" transform="translate(471,31)" />

      <path class="bill-line" d="M0,0 L1,2 L-6,14 L-17,29 L-27,42 L-38,60 L-52,80 L-60,90 L-73,107 L-81,118 L-87,129 L-94,144 L-95,147 L-97,147 L-98,153 L-104,166 L-109,180 L-111,190 L-112,191 L-114,205 L-114,224 L-112,230 L-102,232 L-102,234 L-95,234 L-75,238 L-60,242 L-30,247 L-22,249 L-8,251 L8,254 L28,258 L39,260 L65,265 L95,271 L111,274 L133,279 L159,284 L175,287 L191,291 L189,286 L188,275 L191,251 L193,245 L199,224 L203,214 L206,206 L208,206 L211,196 L215,188 L221,177 L228,164 L230,164 L228,170 L223,179 L214,196 L210,205 L201,229 L196,244 L192,263 L190,276 L200,277 L214,281 L214,285 L210,285 L209,288 L204,291 L201,291 L201,293 L193,294 L177,290 L156,286 L125,280 L106,276 L69,269 L45,264 L27,260 L1,256 L-30,250 L-60,245 L-72,242 L-84,240 L-90,239 L-90,237 L-97,237 L-112,235 L-117,227 L-118,220 L-117,199 L-112,181 L-104,157 L-98,145 L-90,129 L-84,118 L-76,107 L-67,95 L-56,81 L-48,70 L-38,56 L-33,47 L-25,35 L-15,22 L-8,12 L-1,1 Z" transform="translate(327,610)" />

      <path class="bill-line bill-line--light" d="M0,0 L156,1 L208,5 L214,6 L214,7 L208,8 L196,8 L183,6 L180,5 L113,4 L70,4 L6,3 L6,1 L0,1 Z" transform="translate(542,32)" />
      <path class="bill-line bill-line--light" d="M0,0 L1,0 L1,9 L-1,17 L4,16 L19,15 L22,14 L63,11 L78,11 L78,12 L64,14 L41,16 L8,18 L-2,19 L-4,36 L-8,78 L-9,102 L-10,102 L-10,71 L-7,33 L-3,12 Z" transform="translate(717,132)" />
      <path class="bill-line bill-line--light" d="M0,0 L1,0 L2,7 L2,28 L0,100 L-2,130 L-5,165 L-9,199 L-12,216 L-14,214 L-13,205 L-8,165 L-7,150 L-5,133 L-3,101 Z" transform="translate(706,227)" />
      <path class="bill-line bill-line--light" d="M0,0 L1,2 L0,10 L-3,17 L-8,30 L-13,43 L-15,48 L-17,48 L-18,54 L-26,74 L-29,82 L-34,92 L-35,88 L-27,68 L-26,65 L-24,65 L-23,58 L-20,53 L-17,44 L-9,24 L-2,6 Z" transform="translate(395,454)" />

      <g clip-path="url(#familyContentClip)">
        <text class="bill-title bill-title--overlay" x="370" y="146">FAMILY</text>
        <text class="bill-subtitle bill-subtitle--overlay" x="386" y="184">家庭训练投入</text>
        <text class="bill-mini-note bill-mini-note--overlay" x="390" y="216">2026 cost sketch</text>

        <text class="bill-column-label bill-column-label--overlay" x="338" y="262">项目</text>
        <text class="bill-column-label bill-column-label--overlay" x="586" y="262">参考金额</text>
        <path class="bill-line" d="M322 274 C446 270 566 268 696 264" />

        <foreignObject x="${FO_X}" y="${FO_Y}" width="${FO_W}" height="${FO_H}">
          <div xmlns="http://www.w3.org/1999/xhtml" style="font-family:'PFanHuTu','PF HuTu','KaiTi','STKaiti',serif;color:#1a1a1a;width:100%;height:100%;padding:0;box-sizing:border-box;">
            ${billRows}
          </div>
        </foreignObject>

        <path class="bill-line" d="M346 810 C430 811 500 810 586 807" />
        <path class="bill-line" d="M320 846 C442 845 558 845 664 842" />
        <text class="bill-total bill-total--overlay" x="366" y="876">TOTAL</text>
        <text class="bill-total-note bill-total-note--overlay" x="474" y="876">这是一张会越打越长的账单</text>
      </g>

      <path class="bill-outline-top" d="${paperPathD}" transform="translate(471,31)" />
    </svg>
  `;
}
...
function buildCampReceiptSvg() {
  return `
    <svg class="training-bill-svg" viewBox="0 0 360 620" aria-label="National camp bill">
      <path class="bill-paper" d="M92 40 C64 54 48 83 50 121 C52 160 42 214 44 269 C46 336 38 401 53 475 C61 516 69 558 86 602 L299 600 C305 565 323 528 325 485 C329 414 312 348 315 288 C318 237 324 185 314 133 C305 88 283 53 246 42 C204 31 130 22 92 40 Z" />
      <path class="bill-corner" d="M61 154 C76 132 96 121 126 114 C108 96 88 88 66 94 Z" />
      <text class="bill-title bill-title--small" x="92" y="96">NATIONAL CAMP</text>
      <text class="bill-subtitle" x="95" y="123">expense sketch</text>
      <circle class="bill-chart" cx="188" cy="214" r="56" />
      <path class="bill-chart" d="M188 214 L188 158 A56 56 0 0 1 240 193 Z" />
      <text class="bill-note" x="86" y="191">system support</text>
      <path class="bill-arrow" d="M132 198 C147 195 158 188 170 176" />
      <text class="bill-note" x="238" y="172">family add-on</text>
      <text class="bill-note-em" x="252" y="195">~ 5%</text>
      <path class="bill-arrow" d="M230 188 C240 178 247 172 256 169" />
      <path class="bill-funnel" d="M108 320 C142 315 175 314 252 320 C248 370 231 407 201 454 C188 473 175 490 170 517 C164 487 150 467 136 446 C108 405 96 367 108 320 Z" />
      <path class="bill-funnel-mark" d="M156 468 C171 473 183 474 198 468" />
      <path class="bill-funnel-mark" d="M163 488 C174 492 182 492 191 488" />
      <text class="bill-note" x="246" y="386">50: shortlist</text>
      <path class="bill-arrow" d="M230 388 C214 394 203 402 192 414" />
      <text class="bill-note" x="214" y="514">20: final spots</text>
      <path class="bill-arrow" d="M208 510 C195 507 186 503 178 496" />
      <path class="bill-total-line" d="M87 556 C138 564 202 564 267 554" />
      <text class="bill-total" x="88" y="590">shared cost, tighter gate</text>
    </svg>
  `;
}
